  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        <div class="content-wrapper" style="background-image: url('bluework.jpg');   background-size: 1300px auto;  background-repeat: no-repeat;"> <!-- 4. content wrapper starts-->
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `client`");
          $row=$query->fetch(PDO::FETCH_ASSOC);
          $b=implode($row);
          ?>
        <!-- customer counting ends -->
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `labour`");
          $row=$query->fetch(PDO::FETCH_ASSOC);
          $c=implode($row);
          ?>
        <!-- customer counting ends -->
        ...
        <?php
          $query=$admin->ret("SELECT count(*) FROM `service`");
          $row=$query->fetch(PDO::FETCH_ASSOC);
          $d=implode($row);
          ?>
        <!-- customer counting ends -->
        ...
        <div class="row">
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-tale" style="background-color:#002226  !important;">
              <div class="card-body">
          ...
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-dark-blue" style="background-color:#002226 !important;">
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
            <div class="card card-light-blue" style="background-color:#002226 !important;">
              <div class="card-body">
                <p class="mb-4">Number of labours</p>
          ...
          <div class="col-md-6 stretch-card transparent">
            <div class="card card-light-danger" style="background-color:#002226 !important;">
              <div class="card-body">
